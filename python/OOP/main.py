...
p = [employee_1.age, employee_2.age, employee_3.age, employee_4.age]
x = lambda: max(p)

state = total((employe.number_of_employees), None, None, None)

lis = [
    employee_1.working_days,
    employee_2.working_days,
    employee_3.working_days,
    employee_4.working_days,
    employee_5.working_days,
]
state.work = lis
print(" __________________________________\n|                      |           |")
print(f"|   Total Employees :  |  : {state.name}      |".upper())
print(f"|   Maximum Age     :  |  : {x()} Yrs |".upper())
