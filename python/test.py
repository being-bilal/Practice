...
def main():
    ...
    try:
        while True:
            ...
            print(f"  Left Stick:")
            print(
                f"    X: {left_x:6.3f}  Y: {left_y:6.3f}  Magnitude: {left_magnitude:.3f}"
            )
            ...
            print(f"  Right Stick:")
            print(
                f"    X: {right_x:6.3f}  Y: {right_y:6.3f}  Magnitude: {right_magnitude:.3f}"
            )
            ...
            for i in range(4, min(6, joystick.get_numaxes())):
                ...
                print(
                    f"  {axis_name:12}: {trigger_val:5.3f} [{bar}] {int(trigger_val*100):3d}%"
                )
